...
declare -A K=([a]=ª [b]=” [c]=© [d]=ð [e]=€ [f]=đ [g]=ŋ [h]=ħ [i]=→ [k]=ĸ [l]=ł [m]=µ [o]=œ [p]=þ [r]=® [s]=ß [t]=þ [u]=↓ [v]=“ [x]=» [y]=← [z]=« [.]=· [6]=¥)
bindings()
{
case "${REPLY: -1}" in
	...
	8      ) cdir ;; # directory content change signal
	...
	${K[v]}) ((folder_image_preview)) && folder_image_preview=0 || folder_image_preview=1 ;;
